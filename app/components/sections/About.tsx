...
export default function About() {
    return (
        <div className="container mx-auto">
            <div className="flex flex-col justify-center sm:justify-start items-start text-left gap-20 py-15 px-5 my-10">
                ...
                <div className="flex flex-col sm:flex-row w-full justify-between gap-8 text-center py-8">
